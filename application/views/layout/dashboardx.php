				...
				<div class="sidebar-wrapper">
					...
					<ul class="nav">
						...
						<li id="menu3" class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#"> <i class="pe-7s-users"></i> Klien</a>
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo site_url('klien/all'); ?>">Keterangan Klien </a>
								</li>
							</ul> 
						</li>
						<li id="menu4">
			...
			<footer class="footer">
				<div class="container-fluid">
					<p class="copyright pull-left">
						&copy; 2018 <a href="http://www.pusatlayananautisdiy.com" target="blank1">Pusat Layanan Autis Yogyakarta</a>
					</p>
