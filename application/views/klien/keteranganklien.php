		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="col-md-12">
							<h4 style="margin-top:10px;margin-bottom:-10px;">Keterangan Klien</h4>
							<hr />
						</div>
						
						 <div style="margin-top:0px;float:right;" class="col-md-5">
                            <button style="float:right;position:relative;margin-top:-10px;margin-right:0px;" type="submit"><a href="<?php echo site_url('klien/tambahketklien'); ?>">Tambah</a></button><br />
                         </div>
                         <?php 
							...
							<div id="print-tabel" class="print-area" style="">
								<table class="table table-hover table-striped border">
									...
									<tbody>
										<?php 
										 $no=1;
										 // print_r($listketerangan);
										 foreach($listketerangan as $keterangan){
										?>
										<tr>
											<td><?php echo $no; ?>.</td>
											<td><?php echo $keterangan->keterangan; ?></td>
											<td><?php echo $keterangan->diskripsi; ?></td>
											<td style="text-align:center;">
												<a href="<?php echo site_url('klien/editketklien'); ?>" title="Edit" class="pe-7s-tools"></a> 
												&nbsp;&nbsp; 
