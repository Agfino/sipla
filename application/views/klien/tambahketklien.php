		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<span class="title" style="font-size:24px;">Tambah Keterangan Klien</span>
							<p class="category">
								Tambah Keterangan Klien
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12">
					<form accept-charset="utf-8" action="" method="post">
						<div class="col-md-offset-3 col-md-6">
							...
							<input type="text" class="form-group form-control" name="keterangan" value="<?php echo set_value('keterangan'); ?>">	
						</div>
						<div class="col-md-offset-3 col-md-6">
							<label>Diskripsi</label>
							<input type="text" class="form-group form-control" name="diskripsi" value="<?php echo set_value('diskripsi'); ?>">	
						</div>
