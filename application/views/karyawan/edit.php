		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<span class="title" style="font-size:24px;">Edit Karyawan</span>
							<p class="category">
								Edit Karyawan PLA
							</p>
						</div>
					...
					<form action="" method="post">
						...
						<div class="col-md-offset-3 col-md-6">
							...
							<select class="form-control" style="width:200px;">
								<option value="">  -  </option>
								<option value="<?php echo set_value('jk', $user->id); ?>"> Laki-laki </option>
								<option value="<?php echo set_value('jk', $user->id); ?>"> Perempuan </option>
							</select>
						</div>
						<div class="col-md-offset-3 col-md-6">
							<br />
						...
						<div class="col-md-offset-3 col-md-6">
							...
							<input type="date" class="form-group form-control" name="tgl_msk" value="<?php echo set_value('tgl_msk', $user->tgl_msk); ?>">	
						</div>
						<div class="col-md-offset-3 col-md-6">
							<label>Jabatan</label>
