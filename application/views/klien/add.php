		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<span class="title" style="font-size:24px;">Tambah Klien</span>
							<p class="category">
								Tambah Klien PLA
							</p>
						</div>
				...
				<div class="col-md-12">
					<form action="" method="post">
						...
						<div class="col-md-offset-3 col-md-6">
							...
							<input type="text" class="form-group form-control" name="jabatan" placeholder="B / S / KP / GK / L untuk Luar Kota" value="">	
						</div>
						<div class="col-md-offset-3 col-md-6">
						...
						<div style="margin-bottom:20px;" class="col-md-offset-3 col-md-6">
							...
							<textarea class="form-group form-control" name="alamat" placeholder="Non Autis, Speech Delay, DLL"></textarea>
						</div>
						<div style="margin-bottom:20px;" class="col-md-offset-3 col-md-6">
